...
export default function Home() {
  ...
  return (
    <div className="h-screen flex flex-col bg-gradient-to-br from-white via-gray-50 to-indigo-50 dark:from-zinc-950 dark:via-zinc-900 dark:to-indigo-900 text-zinc-900 dark:text-zinc-100 transition-colors duration-500">
      {/* Navbar */}
      <header className="shrink-0 backdrop-blur-md bg-white/70 dark:bg-zinc-900/70 border-b border-zinc-200/50 dark:border-zinc-700/50">
        <div className="mx-auto max-w-6xl px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-tr from-fuchsia-500 to-indigo-600 text-white font-bold">
              BZ
            </span>
      ...
      <main className="flex-grow flex items-center">
        <div className="mx-auto max-w-6xl px-6 grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 rounded-full border border-zinc-200 dark:border-zinc-700 px-3 py-1 text-xs text-zinc-600 dark:text-zinc-300 bg-white/60 dark:bg-zinc-800/60 backdrop-blur-sm">
          ...
          <div className="relative">
            <div className="rounded-3xl border border-zinc-200 dark:border-zinc-700 bg-white/70 dark:bg-zinc-800/70 backdrop-blur-md shadow-2xl overflow-hidden hover:scale-[1.02] transition-transform">
      ...
      {/* Footer */}
      <footer className="shrink-0 border-t border-zinc-200/50 dark:border-zinc-700/50 bg-white/60 dark:bg-zinc-900/60 backdrop-blur-md">
        <div className="mx-auto max-w-6xl px-6 py-4 flex flex-col sm:flex-row items-center justify-between text-sm text-zinc-500 dark:text-zinc-400">
