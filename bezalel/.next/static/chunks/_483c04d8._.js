...
function Canvas(param) {
    let { isDrawingMode, setCanvasRef, isPanning, onPanStart, onPanMove, onPanEnd, onPathCreated, width = 1600, height = 1200 } = param;
    _s();
        ...
        "Canvas.useEffect": ()=>{
            ...
            if (onPathCreated) {
                fabricRef.current.on("path:created", {
                    "Canvas.useEffect": (param)=>{
                        let { path } = param;
                        return onPathCreated(path);
                    }
                }["Canvas.useEffect"]);
            }
            if (setCanvasRef) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("canvas", {
        ...
        onMouseMove: isPanning ? (e)=>onPanMove === null || onPanMove === void 0 ? void 0 : onPanMove(e, lastPanPoint) : undefined,
...
_s(Canvas, "QBExMBN7NipMm0vSj1svZc/tits=");
_c = Canvas;
var _c;
...
function Draw() {
    ...
    const [aiEnabled, setAiEnabled] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [streamingEnabled, setStreamingEnabled] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [isDrawing, setIsDrawing] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    const [peerConnection, setPeerConnection] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // Initialize WebRTC
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Draw.useEffect": ()=>{
            if (streamingEnabled && roomId) {
                var _this, _canvasRef_current;
                const socket = io(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_SIGNALING_URL || "http://localhost:3000");
                setSocket(socket);
                ...
                const stream = (_this = (_canvasRef_current = canvasRef.current) === null || _canvasRef_current === void 0 ? void 0 : _canvasRef_current.getElement()) === null || _this === void 0 ? void 0 : _this.captureStream(30);
                if (stream) {
                    stream.getTracks().forEach({
                        "Draw.useEffect": (track)=>pc.addTrack(track, stream)
                    }["Draw.useEffect"]);
                }
                pc.onicecandidate = ({
                    "Draw.useEffect": (event)=>{
                        if (event.candidate) {
                ...
                pc.createOffer().then({
                    "Draw.useEffect": (offer)=>pc.setLocalDescription(offer)
                }["Draw.useEffect"]).then({
                    "Draw.useEffect": ()=>socket.emit("offer", {
                            sessionId: roomId,
                            offer: pc.localDescription
                        })
                }["Draw.useEffect"]);
                socket.on("answer", {
                    "Draw.useEffect": (answer)=>{
                        pc.setRemoteDescription(new RTCSessionDescription(answer));
                    }
                }["Draw.useEffect"]);
                socket.on("ice-candidate", {
                    "Draw.useEffect": (candidate)=>{
    ...
    const handleEnhance = async (promptText)=>{
        ...
        if (!aiEnabled) return;
        const canvasData = (_canvasRef_current = canvasRef.current) === null || _canvasRef_current === void 0 ? void 0 : _canvasRef_current.toDataURL("image/png");
        try {
            var _canvasRef_current1;
            setError(null);
            ...
            (_canvasRef_current1 = canvasRef.current) === null || _canvasRef_current1 === void 0 ? void 0 : _canvasRef_current1.loadFromJSON(enhancedImage, ()=>{
                var _canvasRef_current;
                return (_canvasRef_current = canvasRef.current) === null || _canvasRef_current === void 0 ? void 0 : _canvasRef_current.renderAll();
            });
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        className: "hover:bg-neutral-700 p-2 rounded ".concat(isPanning ? "bg-neutral-700" : ""),
            ...
            streamingEnabled && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("video", {
                ref: videoRef,
                autoPlay: true,
                muted: true,
                className: "hidden"
...
_s(Draw, "1/PM40zYTF8Vj1QZKF0LIhjOAvw=", false, function() {
    return [
...
_c = Draw;
var _c;
__turbopack_context__.k.register(_c, "Draw");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_483c04d8._.js.map